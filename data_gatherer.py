...
if __name__ == "__main__":
    ...
    df_cleaned = data_gatherer.clean_data(df)

    measures_age = data_gatherer.compute_measures(df_cleaned, 'age')
    measures_bmi = data_gatherer.compute_measures(df_cleaned, 'bmi')
    measures_charges = data_gatherer.compute_measures(df_cleaned, 'charges')
    ...
    data_gatherer.histogram(df_cleaned)
    data_gatherer.scatter_plot(df_cleaned)
    ...
    data_gatherer.correlation_matrix(df_cleaned)
